...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#0f0f0f]/95 backdrop-blur-md border-b border-[#94a288]/30 text-stone-100">
      {/* Top Banner */}
      <div className="bg-[#0c0c0c] text-stone-300 text-[11px] py-1.5 px-3 sm:px-4 font-medium flex flex-wrap items-center justify-between gap-2 border-b border-[#94a288]/20 uppercase tracking-widest max-w-7xl mx-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 rounded bg-[#94a288] hover:bg-[#6b863a] text-black font-bold uppercase text-[11px] tracking-widest transition-colors shadow-md"
            >
        ...
        <div className="flex lg:hidden items-center justify-between gap-2 py-2 border-t border-[#94a288]/20 overflow-x-auto no-scrollbar">
          <button
            onClick={onOpenBooking}
          ...
          <button
            onClick={() => setActiveTab('checkin')}
            className="flex-1 min-w-[110px] flex items-center justify-center gap-1.5 px-2.5 py-2 rounded bg-[#94a288] hover:bg-[#6b863a] text-black font-bold uppercase text-[10px] tracking-wider shadow-md transition"
          >
        ...
        {/* Navigation Tabs */}
        <nav className="flex items-center gap-2 sm:gap-4 overflow-x-auto py-2.5 no-scrollbar border-t border-[#94a288]/20">
          <button
